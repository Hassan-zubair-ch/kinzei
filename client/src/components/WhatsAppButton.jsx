  ...
  return (
    <a
      ...
      style={{
        ...
        right: '28px',
        zIndex: 1500,
        background: 'linear-gradient(135deg, #FCE38A 0%, #D4AF37 50%, #997316 100%)',
        color: '#0A0B0E',
        width: '64px',
        height: '64px',
        borderRadius: '50%',
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 15px 40px rgba(212, 175, 55, 0.75)';
      }}
      onMouseLeave={(e) => {
