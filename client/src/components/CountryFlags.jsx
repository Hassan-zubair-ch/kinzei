...
export function KSAFlag({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: '50%', flexShrink: 0, boxShadow: '0 2px 5px rgba(0,0,0,0.15)' }}>
      <rect width="32" height="32" rx="16" fill="#007A3D"/>
      <path d="M6 18 H26 M8 22 H24" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="16" cy="11" r="3" stroke="#FFFFFF" strokeWidth="1.5" />
    </svg>
  );
}

export function GermanyFlag({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: '50%', flexShrink: 0, boxShadow: '0 2px 5px rgba(0,0,0,0.15)' }}>
      <rect width="32" height="32" rx="16" fill="#000000"/>
      <path d="M0 0H32V10.66H0V0Z" fill="#000000"/>
      <path d="M0 10.66H32V21.33H0V10.66Z" fill="#DD0000"/>
      <path d="M0 21.33H32V32H0V21.33Z" fill="#FFCC00"/>
    </svg>
  );
}
