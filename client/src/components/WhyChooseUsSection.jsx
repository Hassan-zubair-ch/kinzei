  ...
  return (
    <section style={{
      ...
      <div className="container">
        ...
        >
          {/* Left Column: Image with Floating 8+ Years Badge & Favicon Logo */}
          <div style={{ position: 'relative', paddingLeft: '15px', paddingTop: '15px' }}>
            ...
            {/* Top-Left Floating Badge: 8+ Years Experience */}
            <div style={{
              position: 'absolute',
              top: '0px',
              left: '0px',
